...
datatable(matriz,
    ...
    style="caption-side:bottom; text-align:center;", "Table:", htmltools::em("Matriz de Papers Pivotales de Roche Farma (Peru). No todos los articulos listados en la siguiente tabla son Open Source.") 
))
